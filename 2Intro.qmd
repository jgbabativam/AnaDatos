...
```{r, out.width= '100%', fig.align='center'}
knitr::include_graphics(here::here("images/case_when.png"))
```
...
knitr::include_graphics(here::here("images/group_by2.png"))
```

Algunos ejemplos ilustrativos se encuentran [aquí](https://www.andrewheiss.com/blog/2024/04/04/group_by-summarize-ungroup-animations/#summarizing-with-summarize)
...
```{r, out.width= '100%', fig.align='center'}
knitr::include_graphics(here::here("images/group_by.png"))
```
...
```{r, out.width= '100%', fig.align='center'}
knitr::include_graphics(here::here("images/Summarise1.jpg"))
```

## Ejemplo

![](images/grp-summarize-01.gif)


<span style="font-size:70%;">
[Andrew Heiss](https://www.andrewheiss.com/blog/2024/04/04/group_by-summarize-ungroup-animations/#summarizing-with-summarize)</span>
