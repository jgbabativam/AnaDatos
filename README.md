...
https://jgbabativam.github.io/AnaDatos/

Este repositorio reúne los recursos utilizados durante el curso:
materiales de clase, videos de apoyo y enlaces a los contenidos
interactivos.
...
herramientas cuantitativas ampliamente utilizadas en los **estudios
sobre desarrollo**.

A lo largo del curso se introducen métodos para:

-   Exploración y visualización de datos
-   Modelos de regresión
-   Métodos multivariados
-   Análisis aplicado a problemas del desarrollo
...
Durante el curso se utiliza:

-   **R**
-   **RStudio**
-   **R Markdown** para documentos reproducibles
...
-   Materiales asincrónicos (videos y lecturas)
...
El material del curso puede utilizarse con fines educativos citando la
