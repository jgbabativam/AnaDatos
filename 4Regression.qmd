...
**Conjunto de datos:** `precios_viviendas.rds`  
Fuente: [openintro](https://openintro-ims.netlify.app/)


| Variable | Descripción |
|:--|:--|
| **precio** | Precio de venta *(millones de COP)* |
| **habitaciones** | Número de habitaciones |
| **baños** | Número de baños |
| **área** | Área de la vivienda *(m²)* |
| **año_construcción** | Año de construcción |
| **lote** | Área total del terreno |
| **zona** | Ubicación o sector de la vivienda |
...
- El instrumento del DASS 21 permite construir una escala de Depresión, Ansiedad y Estrés (DASS-21). Investigue más sobre su contrucción y propiedades psicométricas. Una versión del instrumento puede ser consultada [aquí](https://la.konradlorenz.edu.co/wp-content/uploads/2025/09/dass-21-2.pdf)
...
library(pacman)
p_load(tidyverse, psych, corrplot, broom, performance, gtsummary)
