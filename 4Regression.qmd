...
El conjunto de datos `precios_viviendas.rds`^[Tomado de (openintro)[https://openintro-ims.netlify.app/]] contiene las siguentes variables
...
| **lote**            | Área de toda la propiedad en metros cuadrados                                   |
