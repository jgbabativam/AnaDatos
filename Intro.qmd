...
- El estudio de `Oxfam` y `La Casa de la Mujer` publicado (aquí)[https://www.oxfamcolombia.org/encuesta-de-prevalencia-de-violencia-sexual-en-contra-de-las-mujeres-en-el-contexto-del-conflicto-armado-colombiano/]. La investigación se realizó en el marco de la Campaña “Violaciones y otras Violencias: Saquen mi cuerpo de la guerra”.

- El estudio se enfocó en zonas donde se tenían alertas tempranas de la Defensoría del Pueblo y tuvo como periodo de referencia los años 2010 a 2016.

- Explore el conjunto del datos `VolenciaMujer.sav` el cual contiene los resultados para una muestra de la encuesta.
