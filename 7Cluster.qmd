...
1. Use los datos electorales para realizar una caracterización usando otras variables categóricas.

2. Use los datos del estudio DASS para realizar una caracterización de los docentes. 
